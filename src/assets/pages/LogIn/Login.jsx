  ...
  return (
      ...
      <div className="w-full lg:w-1/2 p-8 md:p-12 lg:p-20 flex flex-col justify-center">
        <div className="max-w-md mx-auto w-full">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-8">Sign In To <span className="text-[#728cff]">eatly</span></h1>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/SignUp" className="text-[#728cff] font-medium hover:underline" >Sign Up</Link>
